...
function generateAgents(): Agent[] {
    ...
    return Array.from({ length: 50 }, (_, i) => {
        ...
        const prefix = i % 3 === 0 ? "CRAB" : i % 3 === 1 ? "MOLT" : "KISK";
        ...
        return {
            ...
            moltbookMember: Math.random() > 0.3, // 70% are Moltbook members
            joinedAt: new Date(),
            ...
            {selectedAgent && (
                ...
                >
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-[--accent-orange] font-bold">{selectedAgent.name}</span>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-xs">
                        <div>
                            <span className="text-[--text-muted]">Votes Cast:</span>{" "}
                            <span className="text-[--text-secondary]">{selectedAgent.votesCount}</span>
                        </div>
                        <div>
                            <span className="text-[--text-muted]">Consensus Rate:</span>{" "}
                        ...
                        <div>
                            ...
                            <span className={selectedAgent.moltbookMember ? "text-[--accent-neon]" : "text-[--text-muted]"}>
                                {selectedAgent.moltbookMember ? "MEMBER" : "—"}
                            </span>
                        </div>
                    </div>
                </motion.div>
